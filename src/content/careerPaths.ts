...
const pythonDeveloperPhases: CareerPathPhase[] = [
  {
    id: 'python-beginner-foundation',
    title: 'Beginner Foundation',
    subtitle: 'Build confidence with syntax, control flow, and simple problem solving first.',
    duration: '2-3 Weeks',
    color: '#2563eb',
    topics: [
      { title: 'Python syntax and readability', description: 'Understand indentation, comments, naming, and the language style that makes Python productive.' },
      { title: 'Variables and data types', description: 'Work with numbers, strings, booleans, and basic data handling without type confusion.' },
      { title: 'Conditions and loops', description: 'Control application flow with if statements, for loops, while loops, and clean branching.' },
      { title: 'Functions and basic problem solving', description: 'Break work into reusable functions and practice the small logic patterns used in scripts and backend code.' },
    ],
  },
  {
    id: 'python-core',
    title: 'Core Python',
    subtitle: 'Strengthen the language features used in nearly every real project.',
    duration: '3-4 Weeks',
    color: '#16a34a',
    topics: [
      { title: 'Strings and collections', description: 'Use strings, lists, tuples, sets, and dictionaries confidently for everyday data work.', links: [{ label: 'Python Learning Path', to: '/technologies/python' }] },
      { title: 'File handling and exceptions', description: 'Read files safely, parse data, and handle failures without breaking workflows.' },
      { title: 'Modules and virtual environments', description: 'Organize code into modules and isolate dependencies for predictable setup.' },
      { title: 'Comprehensions and slicing', description: 'Use concise collection patterns without hurting readability or correctness.' },
    ],
  },
  {
    id: 'python-oop-clean-code',
    title: 'OOP and Clean Code',
    subtitle: 'Move from scripts to maintainable Python application structure.',
    duration: '2-3 Weeks',
    color: '#7c3aed',
    topics: [
      { title: 'Classes, objects, and constructors', description: 'Model business entities with classes, initialization rules, and instance state.' },
      { title: 'Inheritance and encapsulation', description: 'Reuse behavior carefully without creating tight coupling or confusing class trees.' },
      { title: 'Dunder methods and dataclasses', description: 'Use Pythonic object features to reduce boilerplate and improve readability.' },
      { title: 'Clean project structure', description: 'Split utilities, services, config, and tests into a structure that stays easy to debug and extend.' },
    ],
  },
  {
    id: 'python-practical',
    title: 'Practical Python',
    subtitle: 'Handle real files, APIs, automation, and support-friendly script design.',
    duration: '3-4 Weeks',
    color: '#0891b2',
    topics: [
      { title: 'JSON, CSV, and data handling', description: 'Work with common interchange formats and avoid memory-heavy data-processing mistakes.' },
      { title: 'Requests, APIs, and retries', description: 'Call external services safely with timeouts, auth, parsing, and error classification.' },
      { title: 'CLI tools and automation scripts', description: 'Build practical command-line utilities and operational scripts that teams can actually trust.' },
      { title: 'Logging and debugging', description: 'Add useful logs, inspect failures, and debug issues without relying on guesswork.' },
    ],
  },
  {
    id: 'python-backend-development',
    title: 'Backend Development',
    subtitle: 'Turn Python knowledge into API and service delivery capability.',
    duration: '4-5 Weeks',
    color: '#2563eb',
    topics: [
      { title: 'Flask basics', description: 'Understand lightweight backend routing, request handling, and small-service patterns.' },
      { title: 'FastAPI basics', description: 'Use type-aware API development, validation, and modern backend ergonomics.', links: [{ label: 'REST APIs with Python', to: '/technologies/python/topic/rest-apis-with-python' }] },
      { title: 'Database connectivity and authentication', description: 'Connect Python services to data stores and protect routes with safe auth basics.' },
      { title: 'Environment configuration', description: 'Separate runtime config from code and avoid secret-handling mistakes.' },
    ],
  },
  {
    id: 'python-testing-production',
    title: 'Testing and Production',
    subtitle: 'Prepare Python code for support, reproducibility, and safer releases.',
    duration: '3-4 Weeks',
    color: '#f97316',
    topics: [
      { title: 'pytest and mocking', description: 'Write testable functions, isolate dependencies, and use mocking only where it adds confidence.' },
      { title: 'Error handling and logging discipline', description: 'Make failures understandable, actionable, and safe to support in shared environments.' },
      { title: 'Dependency management and performance basics', description: 'Reduce setup drift, package instability, and avoidable slow paths before they hit production.' },
      { title: 'Production troubleshooting', description: 'Debug memory issues, API failures, bad data, rerun risks, and environment mismatches with evidence-first thinking.' },
    ],
  },
  {
    id: 'python-projects',
    title: 'Projects',
    subtitle: 'Convert topic knowledge into practical proof of capability.',
    duration: '3-4 Weeks',
    color: '#ef476f',
    topics: [
      { title: 'Starter utility projects', description: 'Build a Python CLI calculator, file organizer script, and CSV data processor to sharpen fundamentals.' },
      { title: 'Integration and backend projects', description: 'Ship an API fetch dashboard, a Flask or FastAPI REST API, and an authentication-based API.' },
      { title: 'Automation and scraping projects', description: 'Create a web scraping project, scheduled automation workflow, and file or email automation helper.' },
      { title: 'Testing-focused project', description: 'Build a small Python project with pytest coverage, mocks, logs, and clear runtime configuration.' },
    ],
  },
  {
    id: 'python-interview-preparation',
    title: 'Interview Preparation',
    subtitle: 'Turn Python practice into clear, job-ready answers and scenarios.',
    duration: '2-3 Weeks',
    color: '#16a34a',
    topics: [
      { title: 'Fundamentals and data structures', description: 'Practice explaining syntax, collections, mutability, functions, and common runtime behavior clearly.' },
      { title: 'OOP, decorators, and generators', description: 'Prepare the questions that often reveal whether you understand Python beyond beginner syntax.' },
      { title: 'APIs, testing, and production scenarios', description: 'Rehearse responses around automation, debugging, performance, retries, logging, and support habits.' },
      { title: 'Python interview track', description: 'Use the dedicated Python interview-prep page for category-based revision and scenario practice.', links: [{ label: 'Python Interview Prep', to: '/interview-prep/python' }] },
    ],
  },
  {
    id: 'python-growth-paths',
    title: 'Growth Paths',
    subtitle: 'Use Python as a base for broader backend, automation, and platform growth.',
    duration: '1-2 Weeks',
    color: '#0f766e',
    topics: [
      { title: 'Backend Developer', description: 'Grow into API design, service ownership, deployment, and production support roles.' },
      { title: 'Automation and platform scripting', description: 'Use Python to support operational tooling, internal workflows, and DevOps-friendly automation.' },
      { title: 'Adjacent growth options', description: 'Explore data engineering basics, AI or ML starter paths, and full-stack delivery with React or Next.js.' },
      { title: 'Related technologies', description: 'Pair Python with JavaScript, React, Docker, AWS, and backend architecture thinking for stronger role flexibility.' },
    ],
  },
];
...
export const careerRoadmaps: CareerRoadmap[] = [
  ...
  },
  {
    ...
    technologies: [
      ...
      tech('Docker', '/technologies/docker', 'Container packaging, Dockerfiles, networking, storage, security, and runtime troubleshooting for backend delivery.'),
    ],
    hours: '175+',
    duration: '6-8 Months',
    difficulty: 'Beginner to Advanced',
  ...
  },
  {
    ...
    icon: '🐍',
    description: 'Follow a practical Python Developer career path covering Python fundamentals, data structures, OOP, APIs, backend development, automation, databases, testing, production skills, projects, interview preparation, and growth direction.',
    summary: 'A practical route through Python fundamentals, automation, backend basics, testing, projects, interview preparation, and career growth.',
    technologies: [
      tech('Python', '/technologies/python', 'Syntax, data structures, OOP, files, APIs, backend basics, testing, production habits, and automation workflows.'),
      tech('JavaScript', '/technologies/javascript', 'Useful for frontend integration, browser-side logic, and full-stack growth around Python APIs.'),
      tech('React', '/technologies/react', 'Helpful when you want to build UI clients on top of Python backend services.'),
      tech('Docker', '/technologies/docker', 'Package Python services and scripts for repeatable local, CI, and deployment workflows.'),
      tech('AWS', '/technologies/aws', 'Deploy Python APIs, automation, and integration jobs in cloud environments with stronger operational awareness.'),
    ],
    hours: '140+',
    duration: '5-6 Months',
    difficulty: 'Beginner to Advanced',
    demand: 'High',
    salaryRange: 'INR 6L - 24L+',
    topicCount: 77,
    interviewQuestionCount: 75,
    productionScenarioCount: 5,
    seoTitle: 'Python Developer Career Path | Skills, Projects and Interview Prep - SplashRide',
    seoDescription: 'Follow the Python Developer career path with Python fundamentals, OOP, APIs, automation, backend basics, projects, testing, production skills, and interview preparation.',
    profile: {
      whatYouWillLearn: ['How Python is used in backend, automation, support, and operational workflows', 'How to structure Python code beyond beginner scripts', 'How APIs, files, testing, environments, and debugging fit into real delivery work', 'How to explain Python fundamentals, OOP, production issues, and practical scenarios in interviews'],
      skillsYouWillGain: ['Python programming', 'Automation scripting', 'API integration', 'Backend basics', 'Testing discipline', 'Production troubleshooting'],
      whoThisPathIsFor: ['Beginners targeting Python developer roles', 'Developers moving from scripting into backend work', 'Engineers who want a practical automation and API foundation without going deep into data science first'],
      expectedOutcomes: ['Build practical Python projects', 'Understand backend and automation workflows', 'Handle common production issues', 'Crack technical interviews', 'Become job ready'],
    },
    interviewPrep: {
      primaryTrackLabel: 'Start Python Interview Preparation',
      primaryTrackTo: '/interview-prep/python',
      topicsCovered: ['Fundamentals and collections', 'Functions, modules, and OOP', 'Exceptions, files, APIs, and testing', 'Decorators, generators, and concurrency basics', 'Production troubleshooting and scenario questions'],
      questionCount: 75,
      scenarioCount: 5,
      architectureQuestionCount: 0,
      systemDesignQuestionCount: 0,
      linkedTracks: [
        { label: 'Python Interview Prep', to: '/interview-prep/python' },
        { label: 'JavaScript Interview Prep', to: '/interview-prep/javascript' },
        { label: 'React Interview Prep', to: '/interview-prep/react' },
      ],
      note: 'This path focuses on Python developer, backend, and automation foundations rather than heavy data-science specialization.',
    },
    careerInsights: {
      demand: 'Python remains in strong demand because teams use it for backend services, automation, integrations, testing utilities, internal tools, and cloud workflows.',
      careerGrowth: 'Python developers often grow into backend engineering, automation leadership, data engineering basics, DevOps scripting, AI application support, or full-stack roles paired with React or Next.js.',
      skillsNeeded: ['Clear fundamentals', 'Good debugging habits', 'API and file-handling confidence', 'Testing and environment discipline', 'Comfort with practical automation'],
      experienceExpectations: ['Junior: build scripts, small utilities, and simple backend features', 'Mid-level: own APIs, testing, automation jobs, and production fixes', 'Senior: shape project structure, runtime reliability, and platform standards around Python code'],
      typicalRoles: [
        { title: 'Python Developer', salaryRange: 'INR 6L - 16L', expectation: 'Build scripts, APIs, integrations, and maintainable Python application logic.' },
        { title: 'Backend Python Engineer', salaryRange: 'INR 12L - 24L', expectation: 'Own backend services, deployment readiness, testing, and reliability decisions.' },
        { title: 'Automation or Platform Engineer', salaryRange: 'INR 15L - 28L', expectation: 'Use Python to drive operational tooling, workflow automation, and support-heavy engineering systems.' },
      ],
    },
    resources: resources([
      {
        title: 'Recommended Learning Order',
        items: [
          { label: 'Language before framework', description: 'Strong Python fundamentals make Flask, FastAPI, testing, and automation much easier to reason about.' },
          { label: 'Practical work in parallel', description: 'Do small scripts and file or API tasks while learning syntax so concepts stay grounded.' },
          { label: 'Production habits early', description: 'Logging, dependency isolation, and debugging discipline matter even in small Python projects.' },
        ],
      },
      {
        title: 'Reference Materials',
        items: [
          { label: 'Python learning path', description: 'Use the Python topic library for fundamentals, OOP, APIs, testing, and production basics.', to: '/technologies/python' },
          { label: 'Python interview prep', description: 'Practice category-based Python questions and scenario-driven answers.', to: '/interview-prep/python' },
          { label: 'React and Docker tracks', description: 'Use these when you want to grow from Python foundations into full-stack or deployment workflows.', to: '/technologies/react' },
        ],
      },
    ]),
    phases: pythonDeveloperPhases,
  },
  {
    ...
    technologies: [
      ...
      tech('Docker', '/technologies/docker', 'Containerized local development, release packaging, runtime debugging, and delivery workflows.'),
    ],
    hours: '170+',
    duration: '6-8 Months',
    difficulty: 'Beginner to Advanced',
  ...
  },
  {
    ...
    technologies: [
      tech('AWS', '/technologies/aws', 'Cloud foundations, networking, IAM, storage, databases, serverless, observability, and production-ready architecture patterns.'),
      tech('Docker', '/technologies/docker', 'Container images, runtime operations, networking, storage, security, and release workflows used in cloud delivery.'),
      tech('Kubernetes', '/technologies/kubernetes', 'Orchestration, networking, storage, security, GitOps, troubleshooting, and platform operations.'),
    ],
    hours: '150+',
    duration: '5-7 Months',
    difficulty: 'Beginner to Advanced',
  ...
  },
  {
    ...
    technologies: [
      tech('AWS', '/technologies/aws', 'Infrastructure, networking, identity, observability, serverless messaging, and cloud delivery foundations.'),
      tech('Docker', '/technologies/docker', 'Container packaging, registry management, runtime debugging, security, and delivery workflows.'),
      tech('Kubernetes', '/technologies/kubernetes', 'Operational orchestration, rollout strategy, GitOps, security, and production troubleshooting.'),
      tech('Azure', '/technologies/azure', 'Azure governance, compute, networking, identity, messaging, observability, DevOps, security, and enterprise architecture patterns.'),
    ],
    hours: '155+',
    duration: '5-7 Months',
    difficulty: 'Beginner to Advanced',
  ...
  },
  {
    ...
    technologies: [
      tech('AI / LLM Engineering', '/technologies/ai-llm', 'Machine learning, prompting, RAG, vector search, agents, evaluation, guardrails, observability, and production AI system design.'),
    ...
    resources: resources([
      ...
      },
      {
        title: 'Reference Materials',
        items: [
          { label: 'AI and LLMs track', description: 'Use for machine learning, RAG, prompt engineering, agents, guardrails, observability, and production AI system design.', to: '/technologies/ai-llm' },
  ...
  },
  {
    ...
    technologies: [
      tech('AWS', '/technologies/aws', 'Core cloud services, networking, storage, security, serverless, containers, observability, and architecture.'),
      tech('Docker', '/technologies/docker', 'Container packaging, registry, runtime, security, and deployment patterns often used on AWS.'),
      tech('Kubernetes', '/technologies/kubernetes', 'Cluster operations, GitOps, security, and troubleshooting relevant to containerized AWS workloads.'),
    ],
    hours: '140+',
    duration: '5-6 Months',
  ...
  },
  {
    ...
    technologies: [
      tech('Azure', '/technologies/azure', 'Azure fundamentals, governance, compute, storage, networking, AKS, observability, DevOps, security, and architecture.'),
      tech('Docker', '/technologies/docker', 'Container images, runtime, networking, security, and release skills that carry directly into Azure delivery workflows.'),
      tech('Kubernetes', '/technologies/kubernetes', 'Operational cluster, GitOps, security, and troubleshooting skills relevant to Azure-based platform work.'),
    ],
    hours: '125+',
    duration: '4-6 Months',
