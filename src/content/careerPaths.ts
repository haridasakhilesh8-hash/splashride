...
const frontendPhases: CareerPathPhase[] = [
  ...
  },
  {
    ...
    topics: [
      ...
      { title: 'Performance engineering', description: 'Tune bundle size, caching, lazy loading, Suspense, concurrent rendering, and Core Web Vitals behavior.' },
...
export const careerRoadmaps: CareerRoadmap[] = [
  {
    ...
    profile: {
      whatYouWillLearn: ['How modern frontend applications are structured and shipped', 'How routing, state, advanced rendering, testing, and APIs work together', 'How to debug performance, accessibility, and production issues', 'How senior frontend engineers explain architecture and scalability trade-offs'],
    ...
    interviewPrep: {
      ...
      topicsCovered: ['React fundamentals, hooks, and reducer-driven state', 'Routing, data flow, and server-state patterns', 'Performance, Suspense, and concurrent rendering', 'Testing, debugging, and production incident handling', 'Next.js and frontend architecture'],
      questionCount: 1800,
      scenarioCount: 140,
    ...
    careerInsights: {
      demand: 'Frontend roles remain one of the fastest entry points into product engineering, but companies increasingly expect stronger performance, testing, accessibility, and architecture judgment.',
      careerGrowth: 'Developers typically grow from UI implementation into ownership of design systems, data-fetching patterns, performance, product surfaces, and eventually frontend platform or staff-level responsibilities.',
      skillsNeeded: ['Strong JavaScript and TypeScript fundamentals', 'React component architecture', 'Rendering, routing, and server-state knowledge', 'Performance and testing discipline', 'Clear communication with design and backend teams'],
      experienceExpectations: ['Junior: component implementation and bug fixing', 'Mid-level: end-to-end feature ownership, API integration, and testing discipline', 'Senior: architecture decisions, mentoring, performance, and production triage'],
      typicalRoles: [
