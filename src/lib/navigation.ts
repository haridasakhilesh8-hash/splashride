...
// ─────────────────────────────────────────────────────────────────────────────
const htmlCssCategories: NavCategory[] = [
  {
    id: 'html-css-html-fundamentals',
    title: 'HTML Fundamentals',
    icon: 'CORE',
    items: [
      { slug: 'what-is-html', title: 'What is HTML?' },
      { slug: 'html-document-structure', title: 'HTML Document Structure' },
      { slug: 'semantic-html-deep-dive', title: 'Semantic HTML Deep Dive' },
      { slug: 'headings-paragraphs-links-images', title: 'Headings, Paragraphs, Links, and Images' },
      { slug: 'lists-and-tables', title: 'Lists and Tables' },
      { slug: 'html-forms-validation', title: 'HTML Forms Validation' },
      { slug: 'input-types', title: 'Input Types' },
      { slug: 'labels-and-accessibility', title: 'Labels and Accessibility' },
      { slug: 'aria-basics', title: 'ARIA Basics' },
      { slug: 'tables-best-practices', title: 'Tables Best Practices' },
      { slug: 'images-and-responsive-images', title: 'Images and Responsive Images' },
      { slug: 'audio-and-video-tags', title: 'Audio and Video Tags' },
      { slug: 'iframe-usage', title: 'Iframe Usage' },
      { slug: 'meta-tags-for-seo', title: 'Meta Tags for SEO' },
      { slug: 'open-graph-tags', title: 'Open Graph Tags' },
      { slug: 'favicon-and-manifest-basics', title: 'Favicon and Manifest Basics' },
    ],
  },
  {
    id: 'html-css-css-fundamentals',
    title: 'CSS Fundamentals',
    icon: 'LANG',
    items: [
      { slug: 'what-is-css', title: 'What is CSS?' },
      { slug: 'css-selectors', title: 'CSS Selectors' },
      { slug: 'css-specificity-deep-dive', title: 'CSS Specificity Deep Dive' },
      { slug: 'inheritance-and-cascade', title: 'Inheritance and Cascade' },
      { slug: 'pseudo-classes', title: 'Pseudo-Classes' },
      { slug: 'pseudo-elements', title: 'Pseudo-Elements' },
      { slug: 'css-variables', title: 'CSS Variables' },
      { slug: 'colors-and-typography', title: 'Colors and Typography' },
      { slug: 'box-model', title: 'Box Model' },
      { slug: 'display-property', title: 'Display Property' },
      { slug: 'position-property', title: 'Position Property' },
      { slug: 'css-units', title: 'Units: px, %, rem, em, vh, vw' },
    ],
  },
  {
    id: 'html-css-layouts',
    ...
    items: [
      ...
      { slug: 'flexbox-real-layouts', title: 'Flexbox Real Layouts' },
      { slug: 'css-grid', title: 'CSS Grid' },
      { slug: 'grid-real-layouts', title: 'Grid Real Layouts' },
      { slug: 'position-sticky', title: 'Position Sticky' },
      { slug: 'z-index-and-stacking-context', title: 'Z-Index and Stacking Context' },
      { slug: 'responsive-breakpoints', title: 'Responsive Breakpoints' },
      { slug: 'mobile-first-css', title: 'Mobile-First CSS' },
      { slug: 'common-layout-patterns', title: 'Common Layout Patterns' },
    ],
  },
  {
    id: 'html-css-styling-ui',
    title: 'Styling and UI',
    icon: 'MOD',
    items: [
      { slug: 'buttons-and-cards', title: 'Buttons and Cards' },
      { slug: 'navigation-bars', title: 'Navigation Bars' },
      { slug: 'forms-styling', title: 'Forms Styling' },
      { slug: 'shadows-and-borders', title: 'Shadows and Borders' },
      { slug: 'css-transitions', title: 'CSS Transitions' },
      { slug: 'css-transforms', title: 'CSS Transforms' },
      { slug: 'css-animations', title: 'CSS Animations' },
      { slug: 'css-architecture-basics', title: 'CSS Architecture Basics' },
      { slug: 'bem-naming', title: 'BEM Naming' },
    ],
  },
  {
    id: 'html-css-production-skills',
    title: 'Production Skills',
    icon: 'PRD',
    items: [
      { slug: 'accessibility-basics', title: 'Accessibility Basics' },
      { slug: 'seo-friendly-html', title: 'SEO-Friendly HTML' },
      { slug: 'python-performance-basics', title: 'Performance Basics' },
      { slug: 'common-layout-bugs', title: 'Common Layout Bugs' },
      { slug: 'browser-compatibility-issues', title: 'Browser Compatibility Issues' },
      { slug: 'html-css-best-practices', title: 'Best Practices' },
    ],
  },
];

const javascriptCategories: NavCategory[] = [
  {
    id: 'javascript-core',
    ...
    items: [
      ...
      { slug: 'prototype-and-prototype-chain', title: 'Prototype and Prototype Chain' },
      { slug: 'classes', title: 'Classes' },
      { slug: 'javascript-modules', title: 'Modules' },
      { slug: 'javascript-error-handling', title: 'Error Handling' },
      { slug: 'strict-mode', title: 'Strict Mode' },
      { slug: 'var-let-const', title: 'Variables: var, let, const' },
    ],
  },
  {
    ...
    icon: 'APP',
    items: [
      { slug: 'dom-traversal', title: 'DOM Traversal' },
      { slug: 'dom-manipulation', title: 'DOM Manipulation' },
      { slug: 'javascript-events', title: 'Events' },
      { slug: 'event-bubbling-and-capturing', title: 'Event Bubbling and Capturing' },
      { slug: 'event-delegation', title: 'Event Delegation' },
      { slug: 'forms-handling', title: 'Forms Handling' },
      { slug: 'browser-storage', title: 'Browser Storage' },
      { slug: 'cookies-basics', title: 'Cookies Basics' },
      { slug: 'timers-settimeout-setinterval', title: 'Timers: setTimeout and setInterval' },
    ],
  },
  {
    id: 'javascript-async',
    ...
    items: [
      ...
      { slug: 'api-error-handling', title: 'API Error Handling' },
      { slug: 'event-loop', title: 'Event Loop' },
      { slug: 'microtasks-and-macrotasks', title: 'Microtasks and Macrotasks' },
    ],
  },
  {
    ...
    icon: 'OBJ',
    items: [
      { slug: 'javascript-arrays', title: 'Arrays' },
      { slug: 'array-methods-real-examples', title: 'Array Methods Real Examples' },
      { slug: 'javascript-objects', title: 'Objects' },
      { slug: 'object-methods-real-examples', title: 'Object Methods Real Examples' },
      { slug: 'shallow-copy-vs-deep-copy', title: 'Shallow Copy vs Deep Copy' },
      { slug: 'immutability-basics', title: 'Immutability Basics' },
      { slug: 'json-handling', title: 'JSON Handling' },
      { slug: 'date-handling', title: 'Date Handling' },
      { slug: 'debouncing', title: 'Debouncing' },
      { slug: 'throttling', title: 'Throttling' },
      { slug: 'common-runtime-errors', title: 'Common Runtime Errors' },
      { slug: 'debugging-browser-devtools', title: 'Debugging in Browser DevTools' },
    ],
  },
  {
    id: 'javascript-production-skills',
    title: 'Production Skills',
    icon: 'PRD',
    items: [
      { slug: 'javascript-performance-basics', title: 'JavaScript Performance Basics' },
      { slug: 'avoiding-memory-leaks', title: 'Avoiding Memory Leaks' },
      { slug: 'security-basics-xss', title: 'Security Basics: XSS' },
      { slug: 'form-validation', title: 'Form Validation' },
      { slug: 'api-integration-mistakes', title: 'API Integration Mistakes' },
      { slug: 'browser-compatibility', title: 'Browser Compatibility' },
      { slug: 'clean-code-practices', title: 'Clean Code Practices' },
    ],
  },
];

const pythonCategories: NavCategory[] = [
  {
    id: 'python-fundamentals',
    title: 'Python Fundamentals',
    icon: 'PY',
    items: [
      { slug: 'what-is-python', title: 'What is Python?' },
      { slug: 'python-installation-and-setup', title: 'Python Installation and Setup' },
      { slug: 'python-syntax-basics', title: 'Python Syntax Basics' },
      { slug: 'variables-and-data-types', title: 'Variables and Data Types' },
      { slug: 'operators', title: 'Operators' },
      { slug: 'conditional-statements', title: 'Conditional Statements' },
      { slug: 'loops', title: 'Loops' },
      { slug: 'input-and-output', title: 'Input and Output' },
      { slug: 'comments-and-code-style', title: 'Comments and Code Style' },
    ],
  },
  {
    ...
    items: [
      ...
      { slug: 'list-comprehension', title: 'List Comprehension' },
      { slug: 'dictionary-comprehension', title: 'Dictionary Comprehension' },
      { slug: 'slicing', title: 'Slicing' },
      { slug: 'mutable-vs-immutable-types', title: 'Mutable vs Immutable Types' },
    ],
  },
  {
    ...
    items: [
      ...
      { slug: 'function-arguments', title: 'Function Arguments' },
      { slug: 'default-arguments', title: 'Default Arguments' },
      { slug: 'args-and-kwargs', title: '*args and **kwargs' },
      { slug: 'lambda-functions', title: 'Lambda Functions' },
      { slug: 'scope', title: 'Scope' },
      { slug: 'modules', title: 'Modules' },
      { slug: 'packages', title: 'Packages' },
      { slug: 'pip-and-virtual-environments', title: 'pip and Virtual Environments' },
    ],
  },
  {
    id: 'python-oop',
    ...
    items: [
      ...
      { slug: 'instance-variables-and-class-variables', title: 'Instance Variables and Class Variables' },
      ...
      { slug: 'dunder-methods', title: 'Dunder Methods' },
      { slug: 'dataclasses', title: 'dataclasses' },
    ],
  },
  {
    id: 'python-errors-files',
    title: 'Error Handling and Files',
    icon: 'ERR',
    items: [
      { slug: 'exceptions', title: 'Exceptions' },
      { slug: 'try-except-finally', title: 'try except finally' },
      { slug: 'custom-exceptions', title: 'Custom Exceptions' },
      { slug: 'file-handling', title: 'File Handling' },
      { slug: 'reading-and-writing-files', title: 'Reading and Writing Files' },
      { slug: 'json-handling', title: 'JSON Handling' },
      { slug: 'csv-handling', title: 'CSV Handling' },
  ...
  },
  {
    ...
    items: [
      ...
      { slug: 'python-memory-management', title: 'Python Memory Management' },
      { slug: 'shallow-copy-vs-deep-copy', title: 'Shallow Copy vs Deep Copy' },
      { slug: 'gil-basics', title: 'GIL Basics' },
      { slug: 'multithreading-vs-multiprocessing', title: 'Multithreading vs Multiprocessing' },
    ],
  },
  {
    id: 'python-apis-backend',
    title: 'APIs and Backend Basics',
    icon: 'API',
    items: [
      { slug: 'http-basics', title: 'HTTP Basics' },
      { slug: 'rest-apis-with-python', title: 'REST APIs with Python' },
      { slug: 'requests-library', title: 'Requests Library' },
      { slug: 'flask-basics', title: 'Flask Basics' },
      { slug: 'fastapi-basics', title: 'FastAPI Basics' },
      { slug: 'database-connectivity', title: 'Database Connectivity' },
  ...
  },
  {
    ...
    items: [
      ...
      { slug: 'pytest-basics', title: 'pytest Basics' },
      { slug: 'mocking', title: 'Mocking' },
      { slug: 'debugging', title: 'Debugging' },
      { slug: 'python-performance-basics', title: 'Performance Basics' },
      { slug: 'common-runtime-errors', title: 'Common Runtime Errors' },
      { slug: 'dependency-management', title: 'Dependency Management' },
      { slug: 'production-best-practices', title: 'Production Best Practices' },
    ],
  },
  {
    id: 'python-automation-projects',
    title: 'Automation and Real Projects',
    icon: 'AUT',
    items: [
      { slug: 'python-automation', title: 'Python Automation' },
      { slug: 'web-scraping-basics', title: 'Web Scraping Basics' },
      { slug: 'working-with-apis', title: 'Working with APIs' },
      { slug: 'cli-scripts', title: 'CLI Scripts' },
      { slug: 'data-processing-scripts', title: 'Data Processing Scripts' },
      { slug: 'email-file-automation', title: 'Email/File Automation' },
      { slug: 'scheduling-jobs', title: 'Scheduling Jobs' },
      { slug: 'practical-python-projects', title: 'Practical Python Projects' },
    ],
  },
];
...
export const technologies: TechSection[] = [
  ...
  },
  {
    ...
    icon: '🌐',
    color: '#0ea5e9',
    description: 'Learn HTML and CSS fundamentals including semantic HTML, forms, accessibility, CSS selectors, box model, flexbox, grid, responsive design, layouts, and real-world UI styling.',
    topicCount: 52,
    active: true,
    categories: htmlCssCategories,
  },
  {
    id: 'javascript',
    label: 'JavaScript',
    icon: '🟨',
    color: '#facc15',
    description: 'Learn JavaScript deeply with runtime concepts, DOM and browser APIs, async programming, practical debugging, performance basics, security awareness, and production-ready frontend patterns.',
    topicCount: 50,
    active: true,
  ...
  },
  {
    ...
    icon: '🐍',
    color: '#3776ab',
    description: 'Learn Python with practical tutorials covering syntax, data types, functions, OOP, modules, file handling, exceptions, APIs, automation, backend basics, data handling, testing, production issues, and interview preparation.',
    topicCount: 77,
    active: true,
